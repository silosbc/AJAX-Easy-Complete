...
// Rozdzielanie ciągu wyszukiwania na słowa
$searchWords = explode(' ', $search);

$results = array_filter($oxford5000, function ($item) use ($searchWords) {
    // Usunięcie akcentów z elementu tablicy i przeszukiwanego ciągu
    $itemNormalized = strtolower(remove_accents($item));
    
    // Sprawdzanie, czy każde słowo z wyszukiwanego ciągu jest w elemencie tablicy
